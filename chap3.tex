...
As seen in our dataset statistics in Section~\ref{sec:font-data}, the most common SVG path command used in our input data is the cubic B\'ezier drawing command, \code{c}, by a large margin.
